...
//	GridPane lane5;
    ...
    blane1.setFitHeight(200);
    blane2.setFitWidth(1275);
    blane2.setFitHeight(200);
    blane3.setFitWidth(1275);
    blane3.setFitHeight(200);
    ...
    wall1.setFitHeight(200);
    wall2.setFitWidth(110);
    wall2.setFitHeight(200);
    wall3.setFitWidth(110);
    wall3.setFitHeight(200);
    ...
    piercingview1.setFitWidth(43);
    piercingview1.setFitHeight(43);
    piercingview2.setFitWidth(43);
    piercingview2.setFitHeight(43);
    piercingview3.setFitWidth(43);
    piercingview3.setFitHeight(43);
    ...
    sniper1.setFitWidth(43);
    sniper1.setFitHeight(43);
    sniper2.setFitWidth(43);
    sniper2.setFitHeight(43);
    sniper3.setFitWidth(43);
    sniper3.setFitHeight(43);
    ...
    volley1.setFitWidth(43);
    volley1.setFitHeight(43);
    volley2.setFitWidth(43);
    volley2.setFitHeight(43);
    volley3.setFitWidth(43);
    volley3.setFitHeight(43);
    ...
    walltrap1.setFitWidth(43);
    walltrap1.setFitHeight(43);
    walltrap2.setFitWidth(43);
    walltrap2.setFitHeight(43);
    walltrap3.setFitWidth(43);
    walltrap3.setFitHeight(43);
    ...
    hpw1.setPrefHeight(10);
    hpw2.setPrefWidth(110);
    hpw2.setPrefHeight(10);
    hpw3.setPrefWidth(110);
    hpw3.setPrefHeight(10);
    ...
    resources=new Label("Available Resources= "+250*3);
    activeLanes=new Label("Active Lanes= 3");
...
//    hbox4.getChildren().addAll(wall4,lane4);
//    hbox5.getChildren().addAll(wall5,lane5);
    vbox=new VBox(20);
   ...
   phase.setStyle("-fx-text-fill: #ffffff;");
    ...
    easy=new Scene(root,Screen.getPrimary().getVisualBounds().getWidth(),Screen.getPrimary().getVisualBounds().getHeight());
   }
	private void addTitans(ArrayList<Lane> lanes) 
	{
		...
		for(Lane lane:lanes) 
		{
			...
			for(Titan titan:titans)
			{
	            ...
	            healthBar.setStyle("-fx-accent: green;-fx-control-inner-background: transparent; -fx-border-width: 0;");
	...
	private void lostLanes(ArrayList<Lane> lanes) {
		...
		Rectangle black1=new Rectangle(1385,205);
		Rectangle black2=new Rectangle(1385,205);
		Rectangle black3=new Rectangle(1385,205);
